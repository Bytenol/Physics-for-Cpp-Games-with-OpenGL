/**
 * @file particleCollision.cpp
 * @brief a simple implementation of the newtonian 2d collision response
 * @date 29th Sept, 2024
 * 
...
bool initCanvas(Canvas& canvas, int w, int h) {
    ...
    canvas.window = SDL_CreateWindow("Particle COllision", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, w, h, SDL_WINDOW_SHOWN);
    if(!canvas.window) {
